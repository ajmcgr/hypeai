...
import Agencies from "./pages/customers/Agencies";
import CourseCreators from "./pages/customers/CourseCreators";
import Creators from "./pages/customers/Creators";
import Ecommerce from "./pages/customers/Ecommerce";
import EmployeeTestimonials from "./pages/customers/EmployeeTestimonials";
import Freelancers from "./pages/customers/Freelancers";
import Newsletters from "./pages/customers/Newsletters";
import SaaS from "./pages/customers/SaaS";
