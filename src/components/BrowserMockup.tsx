...
export const BrowserMockup = ({ children, className = "", showAddressBar = true }: BrowserMockupProps) => {
  return (
    <div className={`bg-background rounded-xl shadow-2xl overflow-hidden ${className}`}>
      {/* Browser Chrome */}
