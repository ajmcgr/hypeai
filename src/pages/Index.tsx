    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="container mx-auto px-6 py-20">
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            <h2 className="font-reckless text-4xl font-medium mb-4">
              Share Reviews in a Snap
            </h2>
            <p className="text-lg text-muted-foreground mb-6">
              Share your public review pages and collection forms with a simple link. Make it easy for customers to leave reviews and for prospects to see your social proof.
            </p>
            <ul className="space-y-3">
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-primary flex-shrink-0 mt-0.5" />
                <span>Shareable public review pages</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-primary flex-shrink-0 mt-0.5" />
                <span>Custom collection forms via link</span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-6 h-6 text-primary flex-shrink-0 mt-0.5" />
